...
import '../features/call/events/refresh_call_view_event.dart';
...
class RawPIPViewState extends State<RawPIPView> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((timeStamp) {
      _toggleFloatingAnimationController.forward().whenCompleteOrCancel(() {
        _eventBus.fire(RefreshCallViewEvent());
      });
