  ...
  Widget build(BuildContext context) {
    final Widget child = TextFormField(
      ...
      decoration: InputDecoration(
        ...
        counterStyle: AppTextStyles.s12Base.subText2Color,
      ),
      style: style ?? AppTextStyles.s16w400.text2Color,
            ...
            child: isSponsor
                ? Row(
                    ...
                    children: [
                      ...
                      AppSpacing.gapW8,
                      Text(
                        context.l10n.text_optional,
                        style: AppTextStyles.s12w500.text1Color
