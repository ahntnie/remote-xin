...
class ChooseTalkLanguageView extends BaseView<LanguageController> {
  const ChooseTalkLanguageView({Key? key}) : super(key: key);
  @override
            ...
            ...languages.map((lanItem) {
              ...
              return Column(children: [
                Padding(
                  ...
                  controller.updateTalkLanguageProfile(index);
                }),
