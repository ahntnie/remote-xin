...
class SessionManager {
  ...
  User? getUser() {
    if (sharedPreferences != null) {
      final String? strUser = sharedPreferences!.getString(KeyRes.user);
  ...
  Setting? getSetting() {
    if (sharedPreferences != null) {
      final String? value = sharedPreferences?.getString(KeyRes.setting);
  ...
  List<String> getFavouriteMusic() {
    if (sharedPreferences != null) {
      ...
      if (userString != null && userString.isNotEmpty) {
        final List<dynamic> dummy = json.decode(userString);
