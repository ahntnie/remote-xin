...
import '../modal/agora/agora.dart';
import '../modal/agora/agora_token.dart';
import '../modal/comment/comment.dart';
import '../modal/explore/explore_hash_tag.dart';
import '../modal/file_path/file_path.dart';
import '../modal/followers/follower_following_data.dart';
import '../modal/notification/notification.dart';
import '../modal/nudity/nudity_checker.dart';
import '../modal/nudity/nudity_media_id.dart';
import '../modal/plan/coin_plans.dart';
import '../modal/profileCategory/profile_category.dart';
import '../modal/rest/rest_response.dart';
import '../modal/search/search_user.dart';
import '../modal/setting/setting.dart';
import '../modal/single/single_post.dart';
import '../modal/sound/fav/favourite_music.dart';
...
class ApiService {
  ...
  Future<User> updateProfile(
    ...
    final User user = User.fromJson(jsonDecode(respStr));
  ...
  Future<FilePath> filePath({File? filePath}) async {
    ...
    final respStr = await response.stream.bytesToString();
    final responseJson = jsonDecode(respStr);
    final FilePath path = FilePath.fromJson(responseJson);
    return path;
  }
  ...
  Future<NudityMediaId> checkVideoModerationApiMoreThenOneMinutes(
    ...
    final response = await request.send();
    final respStr = await response.stream.bytesToString();
    final NudityMediaId nudityStatus =
        NudityMediaId.fromJson(jsonDecode(respStr));
    return nudityStatus;
  }
  ...
  Future<NudityChecker> getOnGoingVideoJob(
    ...
    final NudityChecker nudityChecker =
